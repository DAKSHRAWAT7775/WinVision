...
circuits = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\circuits.csv")
constructor_results = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\constructor_results.csv")
constructor_standings = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\constructor_standings.csv")
constructors = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\constructors.csv")
driver_standings = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\driver_standings.csv")
drivers = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\drivers.csv")
lap_times = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\lap_times.csv")
pit_stops = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\pit_stops.csv")
qualifying = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\qualifying.csv")
races = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\races.csv")
results = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\results.csv")
seasons = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\seasons.csv")
sprint_results = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\sprint_results.csv")
status = pd.read_csv(r"C:\Users\daksh\Downloads\f1_dataset\archive\status.csv")
